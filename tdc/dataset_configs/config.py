...
class DatasetConfig(ConfigBase):
    ...
    def __init__(self, dataset_name=None, data_processing_class=None, functions_to_run=None, args_for_functions=None, var_map=None, **kwargs):
    ...
    def processing_callback(self):
        ...
        return lambda dataset: self.data_processing_class.process_data(dataset, self.functions, self.args) if self.data_processing_class is not None else None
