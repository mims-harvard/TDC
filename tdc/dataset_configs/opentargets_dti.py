...
class OpentargetsDTI(ResourceConfig):
    ...
    def __init__(self):
        super(OpentargetsDTI, self).__init__(
            ...
            keys=["opentargets_ra_data_splits", "opentargets_ibd_data_splits", "df"],
            ...
            loader_args=[{
                ...
                "pos_test":
                    ("self",
                     ["opentargets_ra_data_splits", "splits", "pos_test_names"]),
                "neg_train":
                    ("self",
                ...
                "neg_test":
                    ("self",
                     ["opentargets_ra_data_splits", "splits", "neg_test_names"]),
            }, {
