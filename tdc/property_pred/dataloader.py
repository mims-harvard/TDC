...
class ADME(property_dataset.DataLoader):
	...
	def __init__(self, name, path = './data', target = None, print_stats = True):
		super().__init__(name, path, target, print_stats, dataset_names = dataset_names["ADME"])

class Toxicity(property_dataset.DataLoader):
	
	def __init__(self, name, path = './data', target = None, print_stats = True):

		super().__init__(name, path, target, print_stats, dataset_names = dataset_names["Toxicity"])
