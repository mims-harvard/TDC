...
predictions_all_seeds_RDKit = {}
results_all_seeds_RDKit = {}
...
for seed in [1, 2, 3, 4, 5]:
    ...
    predictions_all_seeds_RDKit['seed ' + str(seed)] = predictions
    results_all_seeds_RDKit['seed ' + str(seed)] = results
...
print(to_submission_format(results_all_seeds_RDKit))