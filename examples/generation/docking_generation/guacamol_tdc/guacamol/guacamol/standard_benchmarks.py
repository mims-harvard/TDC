...
from guacamol.common_scoring_functions import TanimotoScoringFunction, RdkitScoringFunction, CNS_MPO_ScoringFunction, \
    IsomerScoringFunction, SMARTSScoringFunction, TDCScoring
...
def docking_5wiu_benchmark() -> GoalDirectedBenchmark:
    specification = uniform_specification(1, 10, 100)
    return GoalDirectedBenchmark(name='docking_5wiu', 
                                 objective=TDCScoring(name = 'docking_5wiu'),
                                 contribution_specification=specification)

def docking_drd3_benchmark() -> GoalDirectedBenchmark:
    specification = uniform_specification(1, 10, 100)
    return GoalDirectedBenchmark(name='docking_drd3', 
