...
class GB_GA_Generator(GoalDirectedGenerator):
    ...
    def generate_optimized_molecules(self, scoring_function: ScoringFunction, number_molecules: int,
        ...
        print("---------- before init", self.oracle_num, 'population_size', self.population_size)
        ...
        for generation in tqdm(range(self.generations)):  ### 1k 
            ...
            pickle.dump(self.smiles2score, open('/project/molecular_data/graphnn/pyscreener/graph_ga/' + str(self.oracle_num) + '.pkl', 'wb'))
...
def main():
    ...
    parser.add_argument('--generations', type=int, default=generations_num) ## 1k -> 10 limit oracle   50*200 = max_oracle_num=10k
